...
RECIPES = {
    "simvastatin": {
        ...
        "passages": [
            ...
            {"field": "adverse_reactions", "section": "6.1", "title": "Clinical Trials Experience", "tags": ["adverse-reactions"]},
            {"field": "adverse_reactions", "section": "6.2", "title": "Postmarketing Experience", "tags": ["adverse-reactions"]},
            {"field": "warnings_and_cautions", "section": "5.1", "title": "Myopathy and Rhabdomyolysis", "tags": ["warnings", "monitoring"]},
            {"field": "warnings_and_cautions", "section": "5.3", "title": "Hepatic Dysfunction", "tags": ["warnings", "liver", "monitoring"]},
            {"field": "pregnancy", "section": "8.1", "title": "Pregnancy", "tags": ["pregnancy"]},
            {"field": "use_in_specific_populations", "section": "8.2", "title": "Lactation", "tags": ["pregnancy"]},
            {"field": "use_in_specific_populations", "section": "8.4", "title": "Pediatric Use", "tags": ["pediatric"]},
            {"field": "use_in_specific_populations", "section": "8.6", "title": "Renal Impairment", "tags": ["renal"]},
            {"field": "use_in_specific_populations", "section": "8.7", "title": "Hepatic Impairment", "tags": ["liver"]},
            {"field": "overdosage", "section": "10", "title": "Overdosage", "tags": ["overdose"]},
            {"field": "mechanism_of_action", "section": "12.1", "title": "Mechanism of Action", "tags": ["mechanism"]},
            {"field": "pharmacokinetics", "section": "12.3", "title": "Pharmacokinetics", "tags": ["mechanism"]},
        ],
    },
    "clarithromycin": {
        ...
        "passages": [
            ...
            {"field": "adverse_reactions", "section": "6.1", "title": "Clinical Trials Experience", "tags": ["adverse-reactions"]},
            {"field": "adverse_reactions", "section": "6.2", "title": "Postmarketing Experience", "tags": ["adverse-reactions"]},
            {"field": "warnings_and_cautions", "section": "5.2", "title": "QT Prolongation", "tags": ["warnings", "monitoring"]},
            {"field": "warnings_and_cautions", "section": "5.3", "title": "Hepatotoxicity", "tags": ["warnings", "liver"]},
            {"field": "pregnancy", "section": "8.1", "title": "Pregnancy", "tags": ["pregnancy"]},
            {"field": "use_in_specific_populations", "section": "8.2", "title": "Lactation", "tags": ["pregnancy"]},
            {"field": "pediatric_use", "section": "8.4", "title": "Pediatric Use", "tags": ["pediatric"]},
            {"field": "use_in_specific_populations", "section": "8.6", "title": "Renal and Hepatic Impairment", "tags": ["renal", "liver"]},
            {"field": "overdosage", "section": "10", "title": "Overdosage", "tags": ["overdose"]},
            {"field": "mechanism_of_action", "section": "12.1", "title": "Mechanism of Action", "tags": ["mechanism"]},
            {"field": "pharmacokinetics", "section": "12.3", "title": "Pharmacokinetics", "tags": ["mechanism"]},
        ],
